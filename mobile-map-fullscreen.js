// FASE 7.6-C — Pantalla completa del mapa, sin persistencia que interfiera con la navegación
(function(){
  ...
  style.textContent=`
    .mobile-map-fs-controls{display:flex!important;position:absolute!important;left:10px!important;bottom:10px!important;right:auto!important;top:auto!important;z-index:80!important;gap:7px!important;flex-wrap:wrap!important;pointer-events:auto!important}
    ...
    .mobile-map-fs-exit{display:none!important}.mobile-map-fs-enter{display:block!important}
    ...
    body.mobile-map-expanded .mobile-map-fs-controls{left:12px!important;bottom:12px!important;right:auto!important;top:auto!important;z-index:100!important}
    ...
    @media(max-width:600px){.map-toolbar{gap:5px!important;padding:8px!important;overflow-x:auto!important;overflow-y:visible!important;flex-wrap:nowrap!important;white-space:nowrap}.map-toolbar .seg{flex:none}.map-toolbar select,.map-toolbar button{flex:none}}
  `;
