const CACHE='memoria-lector-v7-1-5';
const ASSETS=['./','./index.html','./styles.css','./app.js','./map-labels.js','./map-neural-link.js','./backup.js','./duplicate-manager.js','./character-name-guard.js','./relationship-guard.js','./delete-manager.js','./session-manager.js','./cover-manager.js','./mobile-map-fullscreen.js','./manifest.webmanifest','./icon.svg'];
